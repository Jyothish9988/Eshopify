                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @foreach($user as $users)
                                    <form class="form-valide" action="{{url('address_add',$users->id)}}" method="POST">
                                    @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">House <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="house" value="{{$users->house}}" placeholder="Enter Address.." >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Landmark <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="landmark" value="{{$users->landmark}}" placeholder="Enter Landmark.." >
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">City <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="city" value="{{$users->city}}" placeholder="Enter City.." >
                                            </div>
                                        </div>
                                        
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Phone 1<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-username" name="phone" value="{{$users->phone}}" placeholder="Enter Phone.." >
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Delivery Phone  <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-username" name="dphone" value="{{$users->dphone}}" placeholder="Enter Alternate Phone.." >
                                            </div>
                                        </div>
